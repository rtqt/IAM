...
const login_response_type_1 = require("./types/login-response.type");
...
__decorate([
    (0, graphql_1.Mutation)(() => login_response_type_1.LoginResponse),
...
__decorate([
    ...
    (0, graphql_1.Query)(() => admin_type_1.AdminType),
